...
const CROPS_DATABASE = {
  ...
  brinjal: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1659260180173-8d58b38648f8?w=400&q=80",
  },
  cauliflower: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1510627498534-cf7e9002facc?w=400&q=80",
  },
  okra: {
  ...
  papaya: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1526318472351-c75fcf070305?w=400&q=80",
  },
  guava: {
    commonName: "Guava",
  ...
  pomegranate: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541344999736-83eca272f6fc?w=400&q=80",
  },
  watermelon: {
  ...
  oats: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1571508985057-ef4d46f9330f?w=400&q=80",
  },
  ...
  mustard: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1590701068745-481e93a21cf4?w=400&q=80",
  },
  soybean: {
    commonName: "Soybean",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1719846923269-6fdf75444cb8?w=400&q=80",
  },
  sunflower: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1627891374362-c6ca6c675cb3?w=400&q=80",
  },
  groundnut: {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1694654359031-e2db00bd0e93?w=400&q=80",
  },
};
  ...
  return Object.entries(CROPS_DATABASE)
    .filter(
      ([key, crop]) =>
        ...
        (crop.searchAlias && crop.searchAlias.toLowerCase().includes(q))
    )
    .map(([key, crop]) => ({ id: key, ...crop }));
}
